...
const OptimizationCenter: React.FC<OptimizationCenterProps> = ({ onBack }) => {
  ...
  return (
    <div className="p-8 text-white w-full h-full overflow-y-auto">
      ...
      <div className="text-center p-8 bg-gray-800/50 rounded-lg">
        ...
        <p className="text-gray-400">Detailed optimization recommendations will be available here.</p>
      </div>
    </div>
  );
};
